// Type definitions for sladey/node-oauth (oauth fork supporting SHA1-RSA
// Copied from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/oauth/index.d.ts
// and modified for the oauth fork
